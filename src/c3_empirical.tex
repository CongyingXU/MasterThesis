...
\begin{figure*}[h]
    \centering
    \includegraphics[scale=0.88]{fig/rq0-year.pdf}
    %\vspace{-5pt}
...
%     \centering
%     \includegraphics[scale=0.46]{fig/rq0-year.pdf}
%     %\vspace{-5pt}
%     \caption{漏洞年份分布统计}\label{fig:rq0-year}
%     \end{subfigure}
%     \begin{subfigure}[b]{0.45\textwidth}
%     \centering
%     \includegraphics[scale=0.46]{fig/rq0-language.pdf}
%     %\vspace{-5pt}
...
\begin{figure*}[h]
    \centering
    \includegraphics[scale=0.90]{fig/rq0-language.pdf}
